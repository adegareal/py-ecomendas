...
type SuperAdminDialogProps = {
  open: boolean;
  onClose: () => void;
};

function SuperAdminDialog({ open, onClose }: SuperAdminDialogProps) {
  ...
  return (
    <>
      <Dialog
        ...
        description="Cadastre empresas e gerencie os usuários de cada tenant sem sair do painel."
      >
            ...
            <section className="rounded-3xl border border-white/10 bg-[#223245] p-6 shadow-sm">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-300">
                    No novo usuário, você pode escolher a empresa vinculada.
                  </p>
                </div>
